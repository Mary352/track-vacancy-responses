...
export function TableScrollArea() {
   ...
   useEffect(() => {
      ...
      console.log('process.env.NEXT_PUBLIC_CODESANDBOX_HOST ', process.env.NEXT_PUBLIC_CODESANDBOX_HOST)
      console.log('process.env.CODESANDBOX_HOST ', process.env.CODESANDBOX_HOST)
